...
import com.regisk.legacy.arch.ReselectionTarget
import com.regisk.legacy.core.*
import com.regisk.legacy.databinding.ActivityMainMd2Binding
import com.regisk.legacy.di.viewModel
import com.regisk.legacy.ktx.startAnimations
import com.regisk.legacy.ui.home.HomeFragmentDirections
import com.regisk.legacy.utils.HideableBehavior
...
open class MainActivity : BaseUIActivity<MainViewModel, ActivityMainMd2Binding>() {
    ...
    private fun showUnsupportedMessage() {
        if (Info.env.isUnsupported) {
            RegiskDialog(this)
                .applyTitle(R.string.unsupport_regisk_title)
                .applyMessage(R.string.unsupport_regisk_msg, Const.Version.MIN_VERSION)
                .applyButton(RegiskDialog.ButtonType.POSITIVE) { titleRes = android.R.string.ok }
                .cancellable(false)
                .reveal()
        }
