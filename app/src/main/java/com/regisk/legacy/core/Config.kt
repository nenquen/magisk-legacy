...
import com.regisk.legacy.core.utils.refreshLocale
import com.regisk.legacy.data.preference.PreferenceModel
import com.regisk.legacy.data.repository.DBConfig
import com.regisk.legacy.di.ServiceLocator
import com.regisk.legacy.ui.theme.Theme
...
object Config : PreferenceModel, DBConfig {
    ...
    object Key {
        ...
        // system state
        const val REGISKHIDE = "regiskhide"
    }
    ...
    var regiskHide by preference(Key.REGISKHIDE, true)
