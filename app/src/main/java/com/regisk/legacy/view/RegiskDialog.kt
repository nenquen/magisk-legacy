...
import com.regisk.legacy.databinding.DialogRegiskBaseBinding
import com.regisk.legacy.utils.ObservableHost
...
class RegiskDialog(
    ...
    private val binding: DialogRegiskBaseBinding =
        DialogRegiskBaseBinding.inflate(LayoutInflater.from(context))
    ...
    inner class Button : ObservableHost {
        ...
        fun clicked() {
            ...
            onClickAction(this@RegiskDialog)
